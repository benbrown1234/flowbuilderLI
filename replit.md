...
## Recent Changes
- 2025-11-27: Improved structure layout - campaign names wrap to show full text, proper spacing between campaigns, ads in 2-column grid to the right, flow lines connect to left-column ads only
